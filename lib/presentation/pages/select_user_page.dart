...
import 'package:flip_flop_game/usecase/select/select_bloc.dart';
...
class SelectUserPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocProvider(
        create: (context) => getIt<SelectBloc>(),
                    ...
                    builder: (context, AsyncSnapshot<List<Player>?> snapshot) {
                      ...
                      if (playerList.isNotEmpty) {
                        ...
                        BlocProvider.of<SelectBloc>(context)
                            .add(SelectEvent.onPlayerSelected(playerList[0]));
                      }

                      return BlocConsumer<SelectBloc, SelectState>(
                        ...
                        builder: (context, state) {
                          return DropdownButton<Player>(
                            ...
                            onChanged: (Player? newValue) {
                              player = newValue!;
                              BlocProvider.of<SelectBloc>(context)
                                  .add(SelectEvent.onPlayerSelected(newValue));
                            },
                            items: playerList
